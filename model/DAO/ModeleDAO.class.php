<?php
    ...
    class ModeleDAO implements DAO {
         ...
         * @param $unNouveauModele
         * @return array|null $ModeleInserer l'objet modele tel qu'il est inserer dans la bd
         * @throws Exception
         */
         ...
         * @return bool unModele le modele tel qu'il est enregistre dans la bd
         * @throws Exception
         */
         ...
         * @return boolean  true si l'objet Modele existe et a bien ete supprime ou false dans les autres cas
         * @throws Exception
         */
