<div class="header">
    ...
    <div class="top_header">
        ...
        <div class="compteLink">
            ...
            <?php if (isset($_SESSION['panier'])): ?>
                <a href="index.php?action=panier"><img class="iconCart" src=".\view\pictures\icons\iconfinder_shopping-cart-full.png" alt="icone panier plein"></a>
            <?php elseif (isset($_SESSION['connecte']) && $_SESSION['connecte'] == 'administrateur'): ?>
                <img class="iconCart" src=".\view\pictures\icons\admin.png" alt="icone administration">
            <?php else: ?>
                <a href="index.php?action=panier"><img class="iconCart" src=".\view\pictures\icons\iconfinder_shopping-cart.png" alt="icone panier vide"></a>
            <?php endif; ?>
        </div>
    </div>
    <div class="bottom_header">
        <ul class="nav_top">
            ...
            <?php if(isset($_SESSION['connecte']) && $_SESSION['connecte'] == 'client'): ?>
                <li class="nav_link"  ><a href="index.php?action=monCompte">Mon compte</a></li>
            <?php elseif (isset($_SESSION['connecte']) && $_SESSION['connecte'] == 'administrateur'): ?>
                <li class="nav_link"  ><a href="index.php?action=administration" class="red">Administration</a></li>
            <?php endif; ?>
