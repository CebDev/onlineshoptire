                ...
                <table class="recherche-tab">
                    ...
                    <tr>
                        <td>
                            ...
                            <img class="iconWeather" src="./view/pictures/icons/sunfull.svg" alt="icone soleil">
                        </td>
                        <td>
                            <input type="radio" name="type" value="w" checked> Winter</br>
                            <img class="iconWeather" src="./view/pictures/icons/ice.svg" alt="icone hivers">
                        </td>
                        <td>
                            <input type="radio" name="type" value="ws" checked> Toutes saisons</br>
                            <img class="iconWeather" src="./view/pictures/icons/rainfull.svg" alt="icone allweather">
                        </td>
                    </tr>
                </table>


                <input class="btn btnAble" type="submit" value="CHERCHER">
            </form>