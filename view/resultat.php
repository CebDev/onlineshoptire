        ...
        <?php foreach($controleur->getTabResultatRecherche() as $article): ?>
            <div class="article-container">
                <div class="image-container">
                    <img class="pictureItem" src="<?= $article->getPictureLink() ?>">
                ...
                <div class="article-info">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th>REFERENCE:</th>
                            <td class="color-info"><?= $article->getIdItem() ?></td>
                        </tr>
                        <tr>
                            <th colspan="3" class="color-info center">
                                <?php if($article->saison() == "Hiver"): ?>
                                    <h4>PNEUS HOMOLOGUES POUR l'HIVERS   </h4><img class="iconWeather" src="./view/pictures/icons/ice.svg" alt="icone hivers">
                                <?php endif; ?>
                            </th>
                        </tr>
                    </table>
                ...
                <form action="index.php?action=panier" method="post" class="order-part" >
                    ...
                    <?php if ($article->getStock() > 0): ?>
                        ...
                        <select name="quantiteCommande" id="quantiteCommande">
                            <?php for($i=1; $i<=$article->getStock();$i++): ?>
                                <?php if($i>4){break;} ?>
