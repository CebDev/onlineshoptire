...
<?php else: ?>
    <div class="conteneurPanier">
        ...
        <table>
            ...
            <tr>
                <?php if($controleur->getActeur() == "visiteur"): ?>
                    <td colspan="2"><button type="button" name="Retirer" class="btn btnAble" onclick="loadLogin()"> Se connecter </button></td>
                <?php else: ?>
                    <td colspan="2"><button type="button" name="Retirer" class="btn btnAble" onclick="loadPaiement()"> Paiement </button></td>
                <?php endif; ?>
            </tr>
        </table>
    </div>
...
<?php include './view/includes/paiement.inc.php' ?>
